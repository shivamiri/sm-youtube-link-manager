            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    <a href="../index.php" target="_blank" class="text-gray-400 hover:text-white transition duration-200 text-sm flex items-center gap-1">
                        <i class="fa-solid fa-arrow-up-right-from-square"></i> <span class="hidden sm:inline">View Site</span>
                    </a>
                    <div class="h-6 w-px bg-gray-700"></div>
                    <a href="?logout=true" onclick="return confirm('Are you sure you want to logout?');" class="bg-red-500/10 hover:bg-red-500/20 text-red-500 px-4 py-2 rounded-lg text-sm font-medium transition duration-200 border border-red-500/20 flex items-center gap-2">
